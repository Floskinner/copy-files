...
// configuration step. It creates a namespace called `copy_files`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", copy_files::cmake::project_name, copy_files::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", copy_files::cmake::project_version);
      return EXIT_SUCCESS;
    }
